...
t(4).name = 'RescaleSlope';         t(4).groupnumber = '0028'; t(4).elementnumber = '1053'; t(4).type = 'num';   t(4).default=1;

%%% Add more tags here that you will require %%% 

%Image information 
t(5).name = 'SliceThickness';         t(5).groupnumber = '0018'; t(5).elementnumber = '0050'; t(5).type = 'num';    t(5).default=0;
t(6).name = 'SpacingBetweenSlices';   t(6).groupnumber = '0018'; t(6).elementnumber = '0088'; t(6).type = 'num';   t(6).default=0;

%How & where the image data is stored, possible types: char, num, uint8, uint16, single
t(7).name = 'Rows';                  t(7).groupnumber = '0028'; t(7).elementnumber = '0010'; t(7).type = 'uint16'; t(7).default=512;
t(8).name = 'Columns';               t(8).groupnumber = '0028'; t(8).elementnumber = '0011'; t(8).type = 'uint16'; t(8).default=512;
t(9).name = 'PixelSpacing';          t(9).groupnumber = '0028'; t(9).elementnumber = '0030'; t(9).type = 'num'; t(9).default=[];
t(10).name = 'RescaleIntercept';      t(10).groupnumber = '0028'; t(10).elementnumber = '1052'; t(10).type = 'num'; t(10).default=-1024;

%not relevant
%t(7).name = 'TriggerTime';            t(7).groupnumber = '0018'; t(7).elementnumber = '1060'; t(7).type = 'char';   t(7).default=0;
%t(8).name = 'SliceLocation';          t(8).groupnumber = '0020'; t(8).elementnumber = '1041'; t(8).type = 'char';   t(8).default=0;
%t(9).name = 'ImagePosition';          t(9).groupnumber = '0021'; t(9).elementnumber = '1054'; t(9).type = 'uint16'; t(9).default=0;
%t(10).name = 'ImageOrientation';      t(10).groupnumber = '0020'; t(10).elementnumber = '0035'; t(8).type = 'char'; t(10).default=0;
%t(14).name = 'BitsAllocated';         t(14).groupnumber = '0028'; t(14).elementnumber = '0100'; t(14).type = 'num'; t(14).default=16;
%t(15).name = 'BitsStored';            t(15).groupnumber = '0028'; t(15).elementnumber = '0101'; t(15).type = 'num'; t(15).default=16;
%t(16).name = 'HighBit';               t(16).groupnumber = '0028'; t(16).elementnumber = '0102'; t(16).type = 'num'; t(16).default=15;
%t(18).name = 'PixelData';             t(18).groupnumber = '7ef0'; t(18).elementnumber = '0010'; t(18).type = 'num'; t(18).default=0;
